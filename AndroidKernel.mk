...
$(KERNEL_CONFIG): $(KERNEL_OUT)
	$(MAKE) -C kernel-3.10 O=../$(KERNEL_OUT) ARCH=$(KERNEL_ARCH) MTK_TARGET_PROJECT=hermes TARGET_BUILD_VARIANT=user CROSS_COMPILE=$(KERNEL_CROSS_COMPILE) ROOTDIR=$TOP $(KERNEL_DEFCONFIG)
